...
begin
  ...
  serial.WriteData('Y 0 0.900' + chr(10));     //POSIÇÃO 3    // avança 0.900 em Y
...
Procedure Estado_inicial_solenoides;
 ...
 function delay(dt : DWORD):integer;   //Criando uma sub-rotina para gerar DELAY
  //var tc :DWORD;
 begin
      //tc := GetTickCount64;
      //while(GetTickCount64 < tc + dt) and (not Application.Terminated) do
...
//-----------(INICIO)- QUINTA QUEBRA DO PROCESSO-(LIBERA O TERCEIRO CONTROLE )--
 ...
 //-----------(FIM)-QUINTA QUEBRA DO PROCESSO---(LIBERA O  TERCEIRO CONTROLE)---
  ...
  Estado_inicial_solenoides;   // DESENERGIZAÇÃO DAS SOLENOIDES
